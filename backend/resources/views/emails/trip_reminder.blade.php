                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" style="padding-top: 8px;">
                                        <p style="margin: 0; font-size: 14px; color: #fef3c7;">Còn khoảng {{ $hoursRemaining }} giờ nữa là đến giờ khởi hành</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 3px solid #f59e0b; background-color: #fffbeb;">
                                <tr>
                                    <td style="padding: 25px; text-align: center;">
                                        ...
                                        <p style="margin: 0; font-size: 42px; color: #b45309; font-weight: bold; font-family: 'Courier New', monospace;">{{ $formatTime($departureTime) }}</p>
                                        <p style="margin: 10px 0 0 0; font-size: 16px; color: #92400e;">{{ $formatWeekday($departureTime) }}, {{ $formatDate($departureTime) }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="40%" valign="top">
                                                    ...
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $leg->pickupLocation?->name ?? $booking->origin_location_id ?? '—' }}</p>
                                                </td>
                                                ...
                                                <td width="40%" valign="top" align="right">
                                                    ...
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $leg->dropoffLocation?->name ?? $booking->destination_location_id ?? '—' }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatList }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatCount }} vé</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($leg->pickup_address ?? '-', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($leg->dropoff_address ?? '-', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td bgcolor="#10b981" style="padding: 15px 40px; border-radius: 8px;">
                                        <a href="{{ config('app.frontend_url') }}/tickets" style="color: #ffffff; font-size: 16px; font-weight: bold; text-decoration: none; display: inline-block;">
