                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="50%" valign="top">
                                        ...
                                        <p style="margin: 0; font-size: 22px; color: #38bdf8; font-weight: bold; letter-spacing: 1px;">{{ $booking->code }}</p>
                                    </td>
                                    <td width="50%" valign="top" align="right">
                                        <p style="margin: 0 0 5px 0; font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">Hành khách</p>
                                        <p style="margin: 0; font-size: 16px; color: #ffffff; font-weight: bold;">{{ $passengerName }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="33%" align="center" style="padding: 20px 10px; border-bottom: 1px solid #e5e7eb; border-right: 1px solid #e5e7eb;">
                                        ...
                                        <p style="margin: 0; font-size: 20px; color: #1f2937; font-weight: bold;">{{ $totalTickets }}</p>
                                    </td>
                                    <td width="34%" align="center" style="padding: 20px 10px; border-bottom: 1px solid #e5e7eb; border-right: 1px solid #e5e7eb;">
                                        ...
                                        <p style="margin: 0; font-size: 20px; color: #1f2937; font-weight: bold;">{{ $tripType }}</p>
                                    </td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="40%" valign="top">
                                                    ...
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $outboundLeg->from_location->name ?? '—' }}</p>
                                                </td>
                                                ...
                                                <td width="40%" valign="top" align="right">
                                                    ...
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $outboundLeg->to_location->name ?? '—' }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td bgcolor="#1e293b" style="padding: 18px 20px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="50%" valign="top">
                                                    <p style="margin: 0; font-size: 32px; color: #ffffff; font-weight: bold; font-family: 'Courier New', monospace;">{{ $formatTime($outboundLeg->trip->departure_time ?? $outboundLeg->depart_at) }}</p>
                                                    <p style="margin: 5px 0 0 0; font-size: 13px; color: #94a3b8;">{{ $formatDate($outboundLeg->trip->departure_time ?? $outboundLeg->depart_at) }}</p>
                                                </td>
                                                <td width="50%" valign="top" align="right">
                                                    <p style="margin: 0; font-size: 14px; color: #ffffff; font-weight: bold; text-transform: capitalize;">{{ $formatWeekday($outboundLeg->trip->departure_time ?? $outboundLeg->depart_at) }}</p>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatList($outboundLeg) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatCount($outboundLeg) }} vé</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($outboundLeg->pickup_address ?? '-', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($outboundLeg->dropoff_address ?? '-', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <td bgcolor="#f9fafb" style="padding: 20px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="40%" valign="top">
                                                    <p style="margin: 0 0 4px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Điểm đi</p>
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $returnLeg->from_location->name ?? '—' }}</p>
                                                </td>
                                                <td width="20%" align="center" valign="middle">
                                                ...
                                                <td width="40%" valign="top" align="right">
                                                    <p style="margin: 0 0 4px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Điểm đến</p>
                                                    <p style="margin: 0; font-size: 18px; color: #1f2937; font-weight: bold;">{{ $returnLeg->to_location->name ?? '—' }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td bgcolor="#1e293b" style="padding: 18px 20px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="50%" valign="top">
                                                    <p style="margin: 0; font-size: 32px; color: #ffffff; font-weight: bold; font-family: 'Courier New', monospace;">{{ $formatTime($returnLeg->trip->departure_time ?? $returnLeg->depart_at) }}</p>
                                                    <p style="margin: 5px 0 0 0; font-size: 13px; color: #94a3b8;">{{ $formatDate($returnLeg->trip->departure_time ?? $returnLeg->depart_at) }}</p>
                                                </td>
                                                <td width="50%" valign="top" align="right">
                                                    <p style="margin: 0; font-size: 14px; color: #ffffff; font-weight: bold; text-transform: capitalize;">{{ $formatWeekday($returnLeg->trip->departure_time ?? $returnLeg->depart_at) }}</p>
                                                    <p style="margin: 5px 0 0 0; font-size: 13px; color: #94a3b8;">Ngày khởi hành</p>
                                                </td>
                                            </tr>
                                        </table>
                                                ...
                                                <td width="50%" style="padding-bottom: 15px;">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <p style="margin: 0 0 2px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Vị trí ghế</p>
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatList($returnLeg) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td width="50%" style="padding-bottom: 15px;">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <p style="margin: 0 0 2px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Số lượng</p>
                                                                <p style="margin: 0; font-size: 14px; color: #1f2937; font-weight: bold;">{{ $seatCount($returnLeg) }} vé</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td width="50%">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <p style="margin: 0 0 2px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Điểm đón</p>
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($returnLeg->pickup_address ?? 'Thông báo qua SMS', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td width="50%">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <p style="margin: 0 0 2px 0; font-size: 10px; color: #6b7280; text-transform: uppercase;">Điểm trả</p>
                                                                <p style="margin: 0; font-size: 13px; color: #1f2937; font-weight: bold;">{{ \Illuminate\Support\Str::limit($returnLeg->dropoff_address ?? 'Thông báo qua SMS', 30) }}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td style="padding: 15px 18px; border-bottom: 1px solid #e5e7eb;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td>
                                                    <span style="font-size: 14px; color: #4b5563;">🚌 Chiều đi ({{ $seatCount($outboundLeg) }} vé)</span>
                                                </td>
                                                <td align="right">
                                                    <span style="font-size: 14px; color: #1f2937; font-weight: bold;">{{ number_format($outboundLeg->total_price ?? 0) }} đ</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding: 15px 18px; border-bottom: 1px solid #e5e7eb;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td>
                                                    <span style="font-size: 14px; color: #4b5563;">🏠 Chiều về ({{ $seatCount($returnLeg) }} vé)</span>
                                                </td>
                                                <td align="right">
                                                    <span style="font-size: 14px; color: #1f2937; font-weight: bold;">{{ number_format($returnLeg->total_price ?? 0) }} đ</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="padding: 15px 18px; border-bottom: 1px solid #e5e7eb;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="font-size: 14px; color: #10b981; font-weight: bold;">-{{ number_format($booking->discount_amount) }} đ</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td bgcolor="#1e293b" style="padding: 18px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="font-size: 24px; color: #4ade80; font-weight: bold;">{{ number_format($booking->total_price ?? 0) }} đ</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
